...
- [1. 動作確認](#1-動作確認)
- [2. メインPCBへの実装](#2-メインPCBへの実装--)
  - [2.1. 電池バネの加工](#21-電池バネの加工--)
  - [2.1. 電池バネの実装](#21-電池バネの実装--)
- [3. 組み立て](#3-組み立て----)
...
　正常に認識されたらまずメインPCB裏面のパッドをピンセットなど導通するものを用いて短絡させてください。
短絡させると`B`と入力されます。
次にUSB端子の横に並んだ6つのスイッチを押してください。
...
## 2. メインPCBへの実装  <img src="../../images/icon_solder.png" width="24px">
